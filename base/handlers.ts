...
module spa {
    ...
    ko.bindingHandlers.limitedText = {
        ...
        update: function (element: HTMLElement, valueAccessor: () => any, allBindingsAccessor: () => any, viewModel: any, bindingContext: KnockoutBindingContext) {
            ...
            if (attr === "text")
                ko.bindingHandlers.text.update(element, spa.createAccessor(result), allBindingsAccessor, viewModel, bindingContext);
            else if (attr === "html")
                ko.bindingHandlers.html.update(element, spa.createAccessor(result), allBindingsAccessor, viewModel, bindingContext);
            else {
                var obj = {};
                obj[attr] = result;
